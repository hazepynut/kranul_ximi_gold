...
struct gpufreq_opp_info g_default_gpu[] = {
    GPUOP(1740000, 105000, 105000, POSDIV_POWER_2, 1875, 0),
	GPUOP(1068000, 85000, 85000, POSDIV_POWER_2, 1875, 0),
	GPUOP(1059000, 84375, 84375, POSDIV_POWER_2, 1875, 0),
	GPUOP(1051000, 83750, 83750, POSDIV_POWER_2, 1875, 0),
	GPUOP(1042000, 83125, 83125, POSDIV_POWER_2, 1875, 0),
	GPUOP(1034000, 82500, 82500, POSDIV_POWER_2, 1875, 0),
	GPUOP(1025000, 81875, 81875, POSDIV_POWER_2, 1875, 0),
	GPUOP(1017000, 81250, 81250, POSDIV_POWER_2, 1875, 0),
	GPUOP(1008000, 80625, 80625, POSDIV_POWER_2, 1875, 0),
	GPUOP(1000000, 80000, 80000, POSDIV_POWER_2, 1875, 0),
	GPUOP(985000,  79375, 79375, POSDIV_POWER_2, 1875, 0),
	GPUOP(970000,  78750, 78750, POSDIV_POWER_2, 1875, 0),
	GPUOP(955000,  78125, 78125, POSDIV_POWER_2, 1875, 0),
	GPUOP(940000,  77500, 77500, POSDIV_POWER_4, 1875, 0),
	GPUOP(925000,  76875, 76875, POSDIV_POWER_4, 1875, 0),
	GPUOP(910000,  76250, 76250, POSDIV_POWER_4, 1875, 0),
	GPUOP(895000,  75625, 75625, POSDIV_POWER_4, 1875, 0),
	GPUOP(880000,  75000, 75000, POSDIV_POWER_4, 1875, 0),
	GPUOP(868000,  74375, 75000, POSDIV_POWER_4, 1875, 0),
	GPUOP(857000,  73750, 75000, POSDIV_POWER_4, 1875, 0),
	GPUOP(846000,  73125, 75000, POSDIV_POWER_4, 1875, 0),
	GPUOP(835000,  72500, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(823000,  71875, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(812000,  71250, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(801000,  70625, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(790000,  70000, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(778000,  69375, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(767000,  68750, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(756000,  68125, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(745000,  67500, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(733000,  66875, 75000, POSDIV_POWER_4, 1250, 0), 
	GPUOP(722000,  66250, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(711000,  65625, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(700000,  65000, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(674000,  64375, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(648000,  63750, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(622000,  63125, 75000, POSDIV_POWER_4, 1250, 0),
	GPUOP(596000,  62500, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(570000,  61875, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(545000,  61250, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(519000,  60625, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(493000,  60000, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(467000,  59375, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(441000,  58750, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(415000,  58125, 75000, POSDIV_POWER_4,  625, 0),
	GPUOP(390000,  57500, 75000, POSDIV_POWER_4,  625, 0),
};
...
unsigned int g_aging_table[][SIGNED_OPP_GPU_NUM] = {
	{ /* aging table 0 */
		...
		1875, 1875, 1875, 1875, 1875, 1875, 1250, 1250, 1250, 1250,
